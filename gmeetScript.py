...
def openMeet(n):
    ...
    driver.find_element_by_name("identifier").send_keys("Put_Email@student.sfit.ac.in")#PUT EMAIL ID HERE
    driver.find_element_by_xpath("//*[@id='identifierNext']/div/button/div[2]").click()

    #waitnig for a small time
    driver.implicitly_wait(10)

    driver.find_element_by_name("password").send_keys("Put_Password")#PUT YOUR PASSWORD HERE
