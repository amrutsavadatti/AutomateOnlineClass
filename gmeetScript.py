...
def openMeet(n):
    ...
    driver.find_element_by_name("identifier").send_keys("YOUR_EMAIL@student.sfit.ac.in")#PUT EMAIL ID HERE
    driver.find_element_by_xpath("//*[@id='identifierNext']/div/button/div[2]").click()

    #waitnig for a small time
    driver.implicitly_wait(10)

    driver.find_element_by_name("password").send_keys("YOUR_PASSWORD")#PUT YOUR PASSWORD HERE
...
if current_time >= timeTable[1][0] and current_time < timeTable[2][0]:
    TT_time = datetime.datetime.combine(date, timeTable[2][0])
...
elif current_time >= timeTable[2][0] and current_time < timeTable[3][0]:
    TT_time = datetime.datetime.combine(date, timeTable[3][0])
    diff = (TT_time - current_timeDelta)
    ...
    TT_time = datetime.datetime.combine(date, timeTable[4][0])
    diff = (TT_time - current_timeDelta)
